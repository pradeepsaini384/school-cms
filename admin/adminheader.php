    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="user_view.php"
                   >
            ...
            <li class="nav-item">
                ...
                <!-- <div id="collapseSchool" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a href = "#"> <h6 class="collapse-header">Classes Dashboard</h6></a>
                        <a class="collapse-item" href="class_create.php">Create Classes</a>
                        <a class="collapse-item" href="class_view.php">View Classes</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTeacher" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Teachers Dashboard</h6>
                        <a class="collapse-item" href="teacher_dashboard.php">Teachers Dashboard</a>
                        <a class="collapse-item" href="teacher_detail.php">Teachers detail</a>
                        <a class="collapse-item" href="teacher_enroll.php">Teachers Admission </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseStudent" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Student Dashboard</h6>
                        <a class="collapse-item" href="student_dashboard.php">Students Dasbhoard</a>
                        <a class="collapse-item" href="student_detail.php">Student detail</a>
                        <a class="collapse-item" href="student_Admission.php">Student Admission </a>
                        <a class="collapse-item" href="student_parmotion.php">Student Permotion </a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseEvent" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white  py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Events Dashboard</h6>
                        <a class="collapse-item" href="event_create.php"> Create Event</a>
                        <a class="collapse-item" href="event_view.php">View Event </a>
