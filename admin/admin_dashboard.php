...
$totalStudentQuery = "SELECT COUNT(*) AS total_teachers FROM students";
$totalStudentResult = $conn->query($totalTeachersQuery);
$totalStudent = $totalStudentResult->fetch_assoc()['total_teachers'];
